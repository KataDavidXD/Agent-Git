...
[![Docs](https://img.shields.io/badge/docs-latest-blue?logo=readthedocs&logoColor=auto)](https://kata-davidxd.github.io/Agent-Git/)
...
Agent Git enables equivalent operations via a three-layer architecture (Figure 1)
